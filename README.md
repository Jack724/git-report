...
- ✅ **Deepseek** - deepseek-chat, deepseek-coder (性价比极高)
...
- [安装说明.txt](安装说明.txt) - 安装步骤说明
- [测试通过报告.md](测试通过报告.md) - 测试验证报告
...
**开发状态**: ✅ MVP v1.4 已完成并测试通过 (批量扫描)

**版本历史**:
- v1.4 (2025-10-21): 批量扫描 + 智能作者识别 + 树形展示
- v1.3 (2025-10-21): 多仓库管理 + 独立作者配置 + 自动迁移
- v1.2 (2025-10-21): 多平台架构 + Token 统计 + 测试连接
- v1.1 (2025-10-21): 支持 OpenAI API 标准
- v1.0 (2025-10-20): MVP 首次发布
